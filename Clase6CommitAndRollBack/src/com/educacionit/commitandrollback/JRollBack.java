...
public class JRollBack {
	...
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace();
			if (connection != null) {
				System.out.println("Haciendo roolback de losposibles cambios");
				try {
					connection.rollback();
				}catch (Exception e2) {
					System.out.println("No se logro volver atras los cambios ERROR GRAVE DE ATOMICIDAD Y CONSISTENCIA ");
				}
			}
